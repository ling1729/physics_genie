...
define("BEFORE_PULL", "/usr/bin/git reset --hard HEAD");               // A command to execute before pulling
define("AFTER_PULL", "sudo chown -R pg:www-pub " + DIR + " && sudo /usr/bin/chmod -R 777 " + DIR);                                              // A command to execute after successfully pulling
