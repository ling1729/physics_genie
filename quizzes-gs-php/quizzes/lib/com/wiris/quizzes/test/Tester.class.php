...
class com_wiris_quizzes_test_Tester {
	...
	public function testCompatibility() {
		...
		haxe_Log::trace("Test compatibility OK!", _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 1138, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "testCompatibility")));
	}
	...
	public function onServiceResponse($id, $res, $q, $qi) {
		try {
			...
			haxe_Log::trace("Test " . $id . " OK!", _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 1068, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "onServiceResponse")));
			$this->endCall();
		}catch(Exception $»e) {
			$_ex_ = ($»e instanceof HException) ? $»e->e : $»e;
			$e = $_ex_;
			{
				haxe_Log::trace("Failed test " . $id . "!!!", _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 1071, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "onServiceResponse")));
	...
	public function responseParameters($res, $q, $qi) {
		$qi->update($res);
		$html = "<p>Ã‰s cert o fals?</p><p>#s</p>";
		$expected = "<p>Ã‰s cert o fals?</p><p>El polinomi <math><mrow><msup><mi>x</mi><mn>3</mn></msup><mo>-</mo><msup><mi>x</mi><mn>2</mn></msup><mo>+</mo><mn>2</mn></mrow></math> tÃ© grau <math><mrow><mn>3</mn></mrow></math>.</p>";
	...
	public function testParameters() {
		...
		$qi = $b->newQuestionInstance($q);
		$qi->setParameter("sentence", "<ms>El polinomi #1 tÃ© grau #2.</ms>");
	...
	public function testCache() {
		...
		if($t2 >= $t1) {
			haxe_Log::trace("WARNING: Uncached question was faster than cached one! time miss: " . _hx_string_rec($t1, "") . "ms, time hit: " . _hx_string_rec($t2, "") . "ms.", _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 813, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "testCache")));
		}
	}
	...
	public function testPerformance() {
		...
		haxe_Log::trace($expanded, _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 771, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "testPerformance")));
	}
	...
	public function responseEncodings2($s, $q, $qi) {
		$texts = new _hx_array(array("â€¢ #a", "2 #b 3"));
		$results = new _hx_array(array("â€¢ 123", "2 < 3"));
		$qi->update($s);
		$i = null;
		{
	...
	public function testCompound() {
		...
		$q2 = $builder->newQuestion()->getImpl();
	...
	public function run() {
		...
		haxe_Log::trace("Service url: " . com_wiris_quizzes_api_QuizzesBuilder::getInstance()->getConfiguration()->get(com_wiris_quizzes_api_ConfigurationKeys::$SERVICE_URL), _hx_anonymous(array("fileName" => "Tester.hx", "lineNumber" => 61, "className" => "com.wiris.quizzes.test.Tester", "methodName" => "run")));
